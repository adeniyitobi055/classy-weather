...
Fetches weather forecast information from an API and displays it for respective countries according to user's search.
...
1. Clone the repository to your local machine:
   ```
   git clone https://github.com/adeniyitobi055/classy-weather
   ```
